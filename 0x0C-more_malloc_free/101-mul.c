 ...
 * Description: exit with stautus 98 if no space
 * Return: pointer
 */
...
/**
 * get_prod - Multiples a string of numbers.
 * @prod: The buffer to store the result
 * @mult: The string of numbers
 * @digit: The single digit
 * @zeroes: The necessary number of leading zeroes
 * Description: exit with ststus of 98
 */
...
/**
 * main - Multiples teo positive numbers
